    ...
    return {
        ...
        indicatorConfigs: {
            ...
            ai: {
                ...
                minConfluence: 4,              // Min indicators agreeing (out of 6)
                minConfidence: 60,             // Min confidence score (0-100)
                sessionFilter: true,           // Filter low-vol sessions
                fundingFilter: true,           // Block during extreme funding
                liquidationFilter: true,       // Block during OI+vol cascades
                aggressiveness: 'balanced',    // 'conservative', 'balanced', 'aggressive'
                contextRefreshInterval: 30000  // Market context refresh (30s)
            }
        },
        orderConfig: {
            amount: 5,
